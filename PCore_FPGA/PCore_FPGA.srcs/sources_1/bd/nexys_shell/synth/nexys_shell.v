...
(* CORE_GENERATION_INFO = "nexys_shell,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=nexys_shell,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "nexys_shell.hwdef" *) 
module nexys_shell
   (clk,
    ddr2_sdram_addr,
    ddr2_sdram_ba,
  ...
  wire [26:0]smartconnect_0_M01_AXI_ARADDR;
  ...
  wire [26:0]smartconnect_0_M01_AXI_AWADDR;
  ...
  nexys_shell_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  nexys_shell_blk_mem_gen_0_0 blk_mem_gen_0
