...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net rst_n_1 [get_bd_ports rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net sys_clk_i_1 [get_bd_ports sys_clk_i] [get_bd_pins mig_7series_0/sys_clk_i]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces m_axi] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
